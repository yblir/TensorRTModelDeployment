...
//
//    curAlgParam->d2is.push_back(
//            {curAlgParam->d2i[0], curAlgParam->d2i[1], curAlgParam->d2i[2],
//             curAlgParam->d2i[3], curAlgParam->d2i[4], curAlgParam->d2i[5]}
//    );
//
////    1.待推理数据异步拷贝到gpu上
...
////    5.后处理, 如果有需要的的话
//      curAlgParam->predictLength = 85;
//      curAlgParam->predictNums = 25200;
